...
# Your task is to independently analyze and refine software project ideas based on the provided information.

# Follow these guidelines:
# 1. If the provided idea lacks clarity, make reasonable assumptions to fill in the gaps.
# 2. Proceed with the analysis and provide a structured summary of the project, including:
#    - Project goals
#    - Target users
#    - Key components or features

# Do not request further clarification from the user. Assume the role of an autonomous analyst, making informed decisions where necessary.
# """
#     ),
...
# thinker_chain = thinker_prompt | llm


# # Optional: A callable version of the node (if needed for graph)
